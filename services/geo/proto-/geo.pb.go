...
func (x *Request) GetLatstring() string {
	if x != nil {
		return x.Latstring
	}
	return ""
...
var file_services_geo_proto_geo_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x6f, 0x22, 0x4b, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10,
	...
	0x6f, 0x6e, 0x12, 0x1c, 0x0a, 0x09, 0x6c, 0x61, 0x74, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6c, 0x61, 0x74, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67,
	...
	0x6c, 0x74, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x67, 0x65, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_services_geo_proto_geo_proto_goTypes = []any{
...
func file_services_geo_proto_geo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_geo_proto_geo_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_geo_proto_geo_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Result); i {
			case 0:
				return &v.state
			case 1:
